...
const editConnectionFormSchema = z.object({
	...
	shopUrl: z.string().trim().min(1, 'Shop URL is required'),
...
export function EditConnectionDialog({
	...
	return (
		<Dialog
			...
			description="Update the Shopify credentials — verified against the platform when they change."
			preventAutoFocus
			footer={
				<>
					<Button
		...
		>
			<Form form={form}>
				...
				<FormField
					...
					name="shopUrl"
					label="Shop URL"
					tooltip="The store's myshopify.com domain"
				>
