...
// Batch delete — count-based type-to-confirm (the user types the NUMBER of
// rows). The dialog gets a SNAPSHOT of the selection, so the mutation's target
// can't drift while it is open.
